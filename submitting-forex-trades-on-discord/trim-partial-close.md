...
{% tab title="Example #2" %}
![](<../.gitbook/assets/image (2).png>)Example of partially closing USD/JPY long position
{% endtab %}

{% tab title="Example #3" %}
![](<../.gitbook/assets/image (3).png>)Example of partially closing USDEUR short position
{% endtab %}
{% endtabs %}
