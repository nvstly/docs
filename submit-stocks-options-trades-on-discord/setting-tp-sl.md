...
When the bot replies to an open position submission, a blue button titled `Add TP/SL` is attached with it's response. Clicking this will prompt a user friendly popup where values can be specified for Take Profit and/or Stop Loss. Set the value for one or both.

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>Set TP/SL popup upon clicking the "Add TP/SL" button</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>Successfully setting or changing TP/SL</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>Example of setting TP/SL values with trade submission notes</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>List command display example</p></figcaption></figure>
