...
{% tab title="Example #2" %}
![](<../.gitbook/assets/image (1) (1) (1) (1) (1).png>)Example of partially closing DOT/USDT position
{% endtab %}

{% tab title="Example #3" %}
![](<../.gitbook/assets/image (2) (1) (1) (1) (1).png>)Example of partially closing ADA/USDT position
{% endtab %}
{% endtabs %}
