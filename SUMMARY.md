...
* [Submit Trades (Stocks/Options, Crypto, Forex)](submit-trades-from-web/submit-trades/README.md)
...
* [Tickers With Special Characters](submit-stocks-options-trades-on-discord/tickers-with-special-characters.md)
...
* [Closing Trades](submit-crypto-trades-on-discord/closing-trades.md)
* [Average Up/Down Positions](submit-crypto-trades-on-discord/average-up-down-positions.md)
...
* [Trade Styles, Risk Flags, & Trade Notes](submit-crypto-trades-on-discord/trade-styles-risk-flags-and-trade-notes.md)
